...
public class Flame extends Entity {
    ...
    private int calculatePermitedDistance() {
        ...
        while (radius < _radius) {
            ...
            if (a instanceof Character) radius++;//nếu là character thì tăng radius
            //vì hàm collide bên dưới khi gặt character trả về false
            if (a.collide(this) == false) //không va chạm  dừng lặp
                break;
